...
docker run -v $current_directory\bay\code:/code -v $current_directory\bay\sys:/irissys -v $current_directory\bay\db:/irisdb -v $current_directory\bay\jrn:/irisjrn --name bay -d intersystems/iris:2022.1.2.574.0
docker run -v $current_directory\tam\code:/code -v $current_directory\tam\sys:/irissys -v $current_directory\tam\db:/irisdb -v $current_directory\tam\jrn:/irisjrn --name tam -d intersystems/iris:2022.1.2.574.0
docker run -v $current_directory\wpb\code:/code -v $current_directory\wpb\sys:/irissys -v $current_directory\wpb\db:/irisdb -v $current_directory\wpb\jrn:/irisjrn --name wpb -d intersystems/iris:2022.1.2.574.0
docker run -v $current_directory\v08\code:/code -v $current_directory\v08\sys:/irissys -v $current_directory\v08\db:/irisdb -v $current_directory\v08\jrn:/irisjrn --name v08 -d intersystems/iris:2022.1.2.574.0
docker run -v $current_directory\vx130\code:/code -v $current_directory\vx130\sys:/irissys -v $current_directory\vx130\db:/irisdb -v $current_directory\vx130\jrn:/irisjrn --name vx130 -d intersystems/iris:2022.1.2.574.0
sleep 20
